...
# ==========================================================
# Execute Deployment - Run this in your terminal
# ==========================================================
...
echo "   cd /Users/bravo/working_code/jan-26/agricultural-platform/backend"
echo "   npm run dev"
echo ""
echo -e "${YELLOW}2. Start frontend (Terminal 2):${NC}"
echo "   cd /Users/bravo/working_code/jan-26/agricultural-platform/frontend"
echo "   npm start"
echo ""
