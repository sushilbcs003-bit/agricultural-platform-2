...
-- Best practice: Payment gateway holds sensitive data; we store only references.
...
COMMENT ON TABLE payment_transactions IS 'Stores only payment references (hashed). No card/account/UPI data.';
